...
/// Excluded by design:
/// <list type="bullet">
///   <item><c>PriorityHigh</c> — amber = high-priority / warning status; shifting it to blue would
///         collide with <c>PriorityMid</c> (already blue).</item>
