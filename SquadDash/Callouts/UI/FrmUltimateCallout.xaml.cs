...
public partial class FrmUltimateCallout : Window, ICalloutWindow {
    ...
    public static FrmUltimateCallout ShowCallout(string markDownText, FrameworkElement target, double width = 200, double angle = double.MinValue, CalloutTheme theme = CalloutTheme.Light, double fontSize = 14, double horizontalPercentOffset = 0) {
    ...
    public static FrmUltimateCallout ShowCallout(string markDownText, Rect target, Window parentWindow, double width = 200, double angle = double.MinValue, CalloutTheme theme = CalloutTheme.Light, double fontSize = 14, double horizontalPercentOffset = 0) {
        var frmUltimateCallout = CreateNewCallout(markDownText, width, theme, fontSize, horizontalPercentOffset);
        frmUltimateCallout.Options.TargetSpacing = fontSize / 2;
        frmUltimateCallout.PointTo(target);
        frmUltimateCallout.SetAngle(angle);
    ...
    private static FrmUltimateCallout CreateNewCallout(string markDownText, double width, CalloutTheme theme, double fontSize = 14, double horizontalPercentOffset = 0) {
