...
public static class Styles {
    /// <summary>
    /// Resource Key for the List Margin.
    /// </summary>
    public static ComponentResourceKey ListKey { get; } = new ComponentResourceKey(typeof(Styles), nameof(ListKey));

    /// <summary>
    /// Resource Key for the List Margin.
    /// </summary>
    public static ComponentResourceKey ListItemKey { get; } = new ComponentResourceKey(typeof(Styles), nameof(ListItemKey));
    ...
    public static readonly string ListMarginKey = "ListMargin";
    public static readonly string Heading1FontSizeKey = "Heading1FontSize";
    public static readonly string Heading2FontSizeKey = "Heading2FontSize";
    public static readonly string Heading3FontSizeKey = "Heading3FontSize";
    public static readonly string Heading4FontSizeKey = "Heading4FontSize";
    public static readonly string Heading5FontSizeKey = "Heading5FontSize";
    public static readonly string Heading6FontSizeKey = "Heading6FontSize";
}