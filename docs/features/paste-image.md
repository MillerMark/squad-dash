...
1. Open the **Cleanup** menu (top menu bar).
...
When you paste an image, SquadDash opens the **Annotation Editor** — a full-screen dialog where you can mark up the image before attaching it.

See **[Annotating Images](annotating-images.md)** for the complete toolbar reference, keyboard shortcuts, Shift+drag axis constraint, and Ctrl+drag copy.
