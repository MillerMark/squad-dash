...
> 📸 *Screenshot needed: Tasks panel open and docked, showing tasks grouped into High (red), Mid (amber), and Low (blue) priority sections with at least one task visible in each group.*
